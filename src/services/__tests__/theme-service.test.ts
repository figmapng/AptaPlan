...
describe('Theme System', () => {
  ...
  it('getThemeColors returns correct colors for specified theme and fallback to ocean', () => {
    ...
    expect(emeraldColors.background).toBe('#F7FAF8');
    ...
    expect(amberColors.background).toBe('#FFFDFA');
    ...
    expect(violetColors.background).toBe('#FAF9FC');
    ...
    expect(fallbackColors.background).toBe('#F8FAFC');
